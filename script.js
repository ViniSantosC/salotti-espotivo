...
const subtitulo2 = document.getElementById("sub2");
const descricao2 = document.getElementById("descricao2");
const imagemModal2 = document.getElementById("modal-img2");
const btnFechar = document.getElementById("fechar")
const btnFechar2 = document.getElementById("fechar2")
const dentro = document.getElementById("modalD")
...
main.addEventListener("click", (event) => {
    ...
    if (divClicada && main.contains(divClicada)) {
        ...
        if (imagem === "supere") {
          ...
          modal.classList.add("aparece");
        } else if (imagem === "video1") {
          titulo2.innerHTML = "video2";
...
btnFechar2.addEventListener("click", () => {
  modal2.classList.remove("aparece");
});